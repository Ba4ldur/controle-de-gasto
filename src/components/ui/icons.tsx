...
/**
 * Ícones em SVG (stroke) — leves, sem dependência externa. Herdam a cor
 * via `currentColor` e o tamanho via classe utilitária.
 */
...
export const BuildingIcon = (p: IconProps) => (
  <svg {...base} {...p}><path d="M4 21V5a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v16" /><path d="M15 9h4a1 1 0 0 1 1 1v11" /><path d="M3 21h18" /><path d="M8 8h3M8 12h3M8 16h3" /></svg>
);

export const ReportIcon = (p: IconProps) => (
  <svg {...base} {...p}><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2z" /><path d="M9 13h6M9 17h6M9 9h1" /></svg>
);
